...
cd build
qmake.exe %PRO_DIR%\FileTransfer.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=console"
if exist %BUILD_DIR%\debug\FileTransfer.exe del %BUILD_DIR%\debug\FileTransfer.exe
